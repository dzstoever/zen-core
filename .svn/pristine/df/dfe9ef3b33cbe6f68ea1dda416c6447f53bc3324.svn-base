...
namespace Zen.Test.AspectTests
{
    public class IocDIProviderScenarios 
    {
        ...
        [Scenario]        
        [InlineData(new object[] { true,  "Zen.Tests.DummyDI, Zen.Tests", typeof(DummyIocDI) })] //other impl
        [InlineData(new object[] { false, "Zen.Tests.DummyDI, Zen.Tests", typeof(DummyIocDI) })] //other impl
