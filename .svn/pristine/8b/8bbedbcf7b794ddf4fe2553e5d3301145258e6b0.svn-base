...
{   
    ...
    { 
        ...
        static Log4netConfigurator()
        {
            ...
            FileMaxSizeKB = "4096";
            FileMaxRollbacks = "9";                        
            SmtpHost = "mailserv.local";
            SmtpEmailTo = "first.last@" + SmtpHost;
            SmtpEmailFrom = StandardLogName + "@zen.log";
            SmtpEmailSubject = StandardLogName + " Error!";
            SqlProcName = @"DB.dbo.usp_InsertMessage";
            SqlCnnString = @"Data Source= .\SQLEXPRESS; Integrated Security=True; Pooling=False";
        ...
        /// <summary>
        /// This must be set to override default settings/ config options
        /// </summary>
        /// <example>
        ...
        /// By default all messages are sent to the Console and Debug appenders
        /// setting this to 'Off' will stop unwanted output from all internal and external loggers
        /// Invidual loggers can still send output to Console and Debug output by turning them on explicitly
        /// </summary>
        ...
        /// <summary>Logging will to be handled by these appenders 
        ...
        /// This property can not be set, use SqlCnnString & SqlProcName
        /// </summary>
        ...
        /// <summary>Info on what appenders are currently turned on/off
        /// </summary>
        public static IDictionary<Appenders, OnOff> AppendersOnOff { get { return _appenders; } }
        ...
        /// <summary>Builds the root logger element and a individual logger elements 
        /// for each logger in the _loggers collection, programmatically
        /// <para>
        ...
        /// </summary>
        /// <remarks>
        /// By default all messages will be sent to the Console and Debug appenders
        /// To avoid this set the RootLogLevel to 'Off'. 
        /// </remarks>
                ...
                foreach (var loggerName in _loggers.Keys)
                {
                    ...
                    if(appenders != null)
                    {
                        foreach (var appender in appenders)
                        {
                            switch (appender)
                            {
                                case Appenders.Console: if (_appenders[Appenders.Console] == OnOff.On) sb.AppendLine("<appender-ref ref='Console'/>"); break;
                                case Appenders.Debug: if (_appenders[Appenders.Debug] == OnOff.On) sb.AppendLine("<appender-ref ref='Debug'/>"); break;                                                            
                                ...
                                case Appenders.Trace: if (_appenders[Appenders.Trace] == OnOff.On) sb.AppendLine("<appender-ref ref='Trace'/>"); break;                                
                            }
                        }
                    }
        ...
        {
            //see if the RtbAppender type is available
            if (appender == Appenders.Rtb && onoff == OnOff.On
                && Type.GetType(_rtbAppenderTypeFQN) == null) return;
        ...
        /// <summary>Turns off all logging for the given logger,
        /// configure=true to apply the configuration change immediately        
        /// </summary>
        ...
        /// <summary>Some default settings can be overriden if .Settings is set prior to calling Configure
        ...
        /// <summary>builds xml from embedded appender configurations
        /// </summary>        
        ...
        /// <summary>Extracts the resource files and adds the xml contents to the stringbuilder.
        ...
        private static void AddAppender(StringBuilder sb, string embeddedFileName)
        {
            ...
            (xmlText.Replace("~DefaultPattern~", DefaultPattern)
                    ...
                    .Replace("~RtbAppenderType~", _rtbAppenderTypeFQN)
            );
        ...
        /// <summary>
        /// This must be set if supplying an RtbAppender implementation other than the one from Zen.Examples...
        /// If you move the Zen.Examples implementaion class to your own namespace, you must still set this.
        /// If the type can not be loaded, than attempts to TurnOn the RtbAppender will fail SILENTLY!
        /// </summary>
        public static Type RtbAppenderType
        { set { _rtbAppenderTypeFQN = value.FullName; } }
        private static string _rtbAppenderTypeFQN = "Zen.Examples.Logging.RtbAppender, Zen.Examples";
    }
}