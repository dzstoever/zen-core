...
namespace Zen.Data
{
    ...
    {              
        ...
        /// Set the mode we use for loading a specific 'object graph'               
        /// </summary>
        /// <param name="key">the property name for the object on the other end of the association</param>
        ...
        IEnumerable<T> Fetch<T>(Query query, int pageIndex, int pageSize) where T : class, new();
        ...
        IEnumerable<T> FetchAll<T>(int pageIndex, int pageSize) where T : class, new();
        ...
        /// </summary>            
        IEnumerable<T> FetchByExample<T>(T entity, string[] excludePropertyList) where T : class, new();

        /// <summary>
        /// Find instances that match the example object
        /// Ignore any propertys in the excludePropertyList
        /// </summary>            
        IEnumerable<T> FetchByExample<T>(T entity, string[] excludePropertyList, int pageIndex, int pageSize) where T : class, new();
        ...
        IEnumerable GetNamedQueryList(string queryName, IDictionary<string, object> parms);
        ...
        IEnumerable<T> FetchAllAndLock<T>() where T : class, new();        
        IEnumerable<T> FetchAllAndLock<T>(int pageIndex, int pageSize) where T : class, new();                
        IEnumerable<T> FetchAndLock<T>(Query query) where T : class, new();
        IEnumerable<T> FetchAndLock<T>(Query query, int pageIndex, int pageSize) where T : class, new();        
        IEnumerable<T> FetchByExampleAndLock<T>(T entity, string[] excludePropertyList) where T : class, new();
        IEnumerable<T> FetchByExampleAndLock<T>(T entity, string[] excludePropertyList, int pageIndex, int pageSize) where T : class, new();        
        */
